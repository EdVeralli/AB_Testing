...
WHERE 
  ...
  between fecha_inicio and fecha_fin and
...
left join fecha on 1=1
WHERE 
  mm.session_creation_time between fecha_inicio and fecha_fin and substr(mm.session_id, 1,20) in 
  ( select 
    ...
    where
      ...
      (cast(vars_value as int) between 1 and 200 and um.session_creation_time between fecha_inicio and fecha_fin)
  )
